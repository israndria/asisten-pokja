...
import spse_browser
from config import SPSE_BASE_URL, TENDER_KUALIFIKASI_SUBFOLDER
...
def resolve_folder_paket(kode_tender: str) -> dict:
    ...
    path = POKJA_ROOT / folder_dibuat / 8. Dokumen Kualifikasi  (dibuat jika belum ada)
    """
    ...
    try:
        ...
        path = os.path.join(TENDER_ROOT, folder_dibuat_safe, TENDER_KUALIFIKASI_SUBFOLDER)
